                    ...
                    <tbody>
                      {carSizeList &&
                        carSizeList.map((carSize) => (
                          <tr key={carSize.id} className="hover:bg-[#f1f1f1] text-[#1c1c1c]">
                            <td>{carSize.size}</td>
                ...
                {openAddCarSizeForm && (
                  <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white p-8 rounded-lg shadow-lg w-1/3">
                      <h2 className="text-3xl font-semibold mb-8">Add | เพิ่มไซต์รถ </h2>
                        ...
                        <div className="space-y-2 mb-4">
                          ...
                          <div className="flex items-center">
                            <label className="label cursor-pointer">                 
                              <input type="checkbox" defaultChecked className="checkbox text-lg" />
                              <span className="label-text mx-3 text-lg">is available</span>
                            </label>
                          </div>
