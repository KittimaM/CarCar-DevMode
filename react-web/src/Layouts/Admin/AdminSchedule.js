                  ...
                  <tbody>
                    {todaySchedule &&
                      todaySchedule.map((item) => (
                        <tr className="hover:bg-[#f1f1f1] text-[#1c1c1c]" key={item.id}>
                          <td>{item.id}</td>
                          <td>{item.car_no}</td>
                          ...
                          <td>
                            ...
                            {item.processing_status == "Paid" && <p className="bg-[#7287fc] text-[#1c1c1c] text-xl p-2 rounded-md w-16">Done</p>}
                            {permission &&
                              permission.includes("4") &&
                              item.processing_status == "Cancel" && <p className="bg-[#d44646] text-[#1c1c1c] text-xl p-2 rounded-md w-16">Cancel</p>}
                          </td>
                          {item.processing_status == "Waiting" && (
                            <td>
                              <button
