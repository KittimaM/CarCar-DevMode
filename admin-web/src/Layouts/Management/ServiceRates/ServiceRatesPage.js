...
import ServiceRatesAddPage from "./ServiceRatesAddPage";
import ServiceRatesEditPage from "./ServiceRatesEditPage";
...
const ServiceRatesPage = ({ data }) => {
  ...
  const filteredAndSortedRates = useMemo(() => {
    let result = serviceRates.filter(
      (s) =>
    ...
    return result;
  }, [serviceRates, searchTerm, sortConfig]);
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-base-content">
              {viewMode === "list" && "Service Rates List"}
              {viewMode === "add" && "Create New Service"}
              {viewMode === "edit" && "Edit Service"}
            </h1>
          </div>
          ...
          <div className="flex gap-2">
            ...
            {actions.includes("add") && viewMode === "list" && (
              ...
              >
                ...
                <span className="hidden sm:inline">Add Service Rate</span>
          ...
          <div className="max-w-6xl">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
              <div className="relative flex-1 max-w-md">
                ...
                <input
                  type="text"
                  placeholder="Search by service or car size..."
              ...
              <p className="text-sm text-base-content/60">
                {filteredAndSortedRates.length} {filteredAndSortedRates.length === 1 ? "service" : "services"} found
              </p>
            </div>
                ...
                <table className="table">
                  <thead>
                    <tr className="bg-base-200/50">
                      ...
                      <SortableHeader label="Car Size" sortKey="size" />
                      <SortableHeader label="Duration" sortKey="duration_minute" />
                      <SortableHeader label="Price" sortKey="price" />
                      <SortableHeader label="Required Staff" sortKey="required_staff" />
                  ...
                  <tbody>
                    {filteredAndSortedRates.length > 0 ? (
                      filteredAndSortedRates.map((s, index) => (
                      ...
                      <tr>
                        <td
                          colSpan={actions.includes("edit") || actions.includes("delete") ? 7 : 6}
                          className="text-center py-12 text-base-content/50"
                        >
                          {searchTerm ? "No services match your search" : "No service rates available"}
                        </td>
                      </tr>
                    )}
                  </tbody>
            ...
            <div className="relative bg-base-100 rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden">
              <div className="p-6 text-center">
                ...
                <p className="text-base-content/70">
                  คุณต้องการลบ <span className="font-semibold text-error">"{deleteConfirm.service_name} - {deleteConfirm.size}"</span> หรือไม่?
                </p>
