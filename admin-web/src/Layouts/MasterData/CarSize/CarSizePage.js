...
import CarSizeAddPage from "./CarSizeAddpage";
import CarSizeEditPage from "./CarSizeEditPage";
...
const CarSizePage = ({ data }) => {
  ...
  const filteredAndSortedSizes = useMemo(() => {
    let result = size.filter(
      (s) => s.size?.toLowerCase().includes(searchTerm.toLowerCase())
    );
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-base-content">
              {viewMode === "list" && "Car Size List"}
              {viewMode === "add" && "Create New Car Size"}
              {viewMode === "edit" && "Edit Car Size"}
            </h1>
          </div>
          ...
          <div className="flex gap-2">
            ...
            {actions.includes("add") && viewMode === "list" && (
              ...
              >
                ...
                <span className="hidden sm:inline">Add Car Size</span>
          ...
          <div className="max-w-6xl">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
              <div className="relative flex-1 max-w-md">
                ...
                <input
                  type="text"
                  placeholder="Search by car size..."
              ...
              <p className="text-sm text-base-content/60">
                {filteredAndSortedSizes.length} {filteredAndSortedSizes.length === 1 ? "size" : "sizes"} found
              </p>
            </div>
                  ...
                  <tbody>
                    {filteredAndSortedSizes.length > 0 ? (
                      ...
                      <tr>
                        ...
                        >
                          {searchTerm ? "No car sizes match your search" : "No car sizes available"}
                        </td>
                      </tr>
                    )}
                  </tbody>
            ...
            <div className="relative bg-base-100 rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden">
              <div className="p-6 text-center">
                ...
                <p className="text-base-content/70">
                  คุณต้องการลบ <span className="font-semibold text-error">"{deleteConfirm.size}"</span> หรือไม่?
                </p>
